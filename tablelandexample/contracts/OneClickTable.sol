...
contract OneClickTable is Ownable, IERC721Receiver{
  ...
  string private constant _TABLE_PREFIX = "oneclick_";
   ...
   // Let anyone insert into the table
    ...
    function updateTable(
      ...
      string memory _ABI
        ...
        string memory setters = string.concat("name=", SQLHelpers.quote(_name), ",", "contractAddress=", SQLHelpers.quote(_contractAddress), ",", "chainID=", SQLHelpers.quote(_chainID), ",", "ABI=", SQLHelpers.quote(_ABI));
